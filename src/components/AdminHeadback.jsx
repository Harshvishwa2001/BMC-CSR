                ...
                <div className='flex items-center gap-4 md:gap-6'>
                    ...
                    <div className='flex items-center gap-2 cursor-pointer group/profile'>
                        <div className='relative'>
                            <div className='w-10 h-10 bg-[#1D4ED8] rounded-full flex items-center justify-center text-white font-semibold text-sm shadow-lg shadow-blue-100 border-2 border-white'>
                                AK
                            </div>
                        </div>
