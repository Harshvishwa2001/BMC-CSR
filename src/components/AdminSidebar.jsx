...
export default function AdminSidebar() {
    ...
    const menuItems = [
        ...
        { icon: <FolderKanban size={20} />, label: 'CSR Projects' },
    ...
    const renderContent = () => {
        switch (activeTab) {
            ...
            case 'CSR Projects': return <ProjectsView />;
    ...
    return (
        <div>
            <aside className="w-18 hover:w-64 max-h-auto relative flex flex-col left-0 top-0 overflow-hidden group transition-all duration-300 z-50">
