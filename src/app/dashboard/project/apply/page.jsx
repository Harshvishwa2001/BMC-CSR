                                                ...
                                                <div className='bg-white p-8 w-212 relative top-10 space-y-4 rounded-2xl'>
                                                    ...
                                                    <form className="flex flex-col gap-5 mt-4" onSubmit={handleNext}>
                                                        ...
                                                        <div className="flex justify-end w-full">
                                                            <button type="submit" className="flex items-center justify-center relative gap-2 w-25 bg-[#0066FF] border border-blue-400 text-[#ffffff] hover:bg-blue-700 hover:text-white py-2 rounded-xl transition-colors cursor-pointer">
                                            ...
                                            <div className='bg-white p-8 w-212 relative top-10 space-y-4 rounded-2xl'>
                                                ...
                                                <form className="flex flex-col gap-5 mt-4" onSubmit={handleNext}>
                                                    ...
                                                    <div className="flex justify-between w-full">
                                                        <button type="button" onClick={handleBack} className="flex items-center justify-center text-sm relative gap-2 w-30 bg-[#FFFFFF] border border-slate-400 text-black hover:bg-slate-100 py-2 px-4 rounded-xl transition-colors cursor-pointer">
                                                            <ArrowLeft size={16} className="text-black font-bold" /> Previous
                                                        </button>
                                                        <button type="submit" className="flex items-center justify-center text-sm relative gap-2 w-25 bg-[#0066FF] border border-blue-400 text-[#ffffff] hover:bg-blue-700 hover:text-white py-2 rounded-xl transition-colors cursor-pointer">
                                        ...
                                        {step === 3 && (
                                            <div className='bg-white p-8 w-212 relative top-10 space-y-4 rounded-2xl'>
                                                ...
                                                <div className="flex justify-between w-full">
                                                    ...
                                                    <button type="button" onClick={() => setStep(4)} className="flex items-center justify-center text-sm relative gap-2 w-25 bg-[#0066FF] border border-blue-400 text-[#ffffff] hover:bg-blue-700 hover:text-white py-2 rounded-xl transition-colors cursor-pointer">
                                                        Next <ArrowRight size={16} className="text-[#ffffff] font-bold" />
                                                    </button>
                                                </div>
                                            </div>
                                        ...
                                        {step === 4 && (
                                            <div className='bg-white p-8 w-212 relative top-10 space-y-4 rounded-2xl'>
                                                ...
                                                <div className="flex justify-between w-full">
                                                    ...
                                                    <button type="button" onClick={() => router.push('/dashboard/project/apply/sucess')} className="flex items-center justify-center text-sm relative gap-2 w-35 bg-[#0066FF] border border-blue-400 text-[#ffffff] hover:bg-blue-700 hover:text-white py-2 rounded-xl transition-colors cursor-pointer">
