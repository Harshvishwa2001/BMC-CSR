...
export default function page() {
    ...
    return (
        <>
            <Sidebar>
                {/* Fixed the outer container to screen height and hide main overflow */}
                            ...
                            <div className="flex flex-col items-center justify-center py-4 px-12">
                                ...
                                <div className="max-w-150 w-full bg-white rounded-3xl shadow-sm border border-gray-100 p-4 flex flex-col items-center text-center">
                                    ...
                                    <div className="w-full flex gap-3 px-10 py-10">
                                        <button className="w-full text-[14px] hover:bg-white text-[#111827] font-medium py-2 px-4 border border-[#E5E7EB] rounded-xl flex items-center justify-center gap-2 cursor-pointer">
                                            <FileText size={16} />View My Applications
                                        </button>
                                        <button onClick={() => router.push('/dashboard')} className="w-full text-[14px] bg-[#1D4ED8] hover:bg-blue-700 text-white py-3 rounded-xl  flex items-center justify-center gap-2 cursor-pointer">
