            ...
            <main className="flex-1 flex flex-col min-w-0 transition-all duration-300">
                ...
                <div className="flex-1 overflow-y-auto">
                    ...
                    <div className='flex flex-col lg:flex-row gap-6 p-6 items-start'>
                        ...
                        <div className='border border-[#E5E7EB] rounded-[14px] flex-1 w-full lg:max-w-250 min-h-screen'>
                            ...
                            <div className='p-6 space-y-6'>
                                ...
                                {activeTab === 'Documents' && (
                                    <div className='space-y-3'>
                                        ...
                                        <div className='p-4 border flex justify-between gap-4 rounded-[10px]'>
                                            <div className='flex  gap-4'>
                                                <FileText size={36} className='text-[#1D4ED8] bg-[#DBEAFE] p-2 rounded-[10px]' />
                                                <div>
                                                    <p className='text-sm text-[#111827] font-medium'>Project_Proposal_Digital_Literacy.pdf</p>
                                        ...
                                        <div className='p-4 border flex justify-between gap-4 rounded-[10px]'>
                                            <div className='flex  gap-4'>
                                                <FileText size={36} className='text-[#1D4ED8] bg-[#DBEAFE] p-2 rounded-[10px]' />
                                                <div>
                                                    <p className='text-sm text-[#111827] font-medium'>ABC_Foundation_CSR_Policy.pdf</p>
                                                    <p className='text-[12px] text-[#6B7280]'>1.8 MB • Uploaded on 28 Mar 2026</p>
                                                </div>
                                            </div>
                                            <div className='text-[#6B7280] flex items-center justify-end gap-6' >
                                                <Eye size={20} />
                                        ...
                                        <div className='p-4 border flex justify-between gap-4 rounded-[10px]'>
                                            <div className='flex  gap-4'>
                                                <FileText size={36} className='text-[#1D4ED8] bg-[#DBEAFE] p-2 rounded-[10px]' />
                                                <div>
                                                    <p className='text-sm text-[#111827] font-medium'>Financial_Statements_2023-24.pdf</p>
                                                    <p className='text-[12px] text-[#6B7280]'>3.2 MB • Uploaded on 28 Mar 2026</p>
                                                </div>
                                            </div>
                                            <div className='text-[#6B7280] flex items-center justify-end gap-6' >
                                                <Eye size={20} />
                                        ...
                                        <div className='p-4 border flex justify-between gap-4 rounded-[10px]'>
                                            <div className='flex  gap-4'>
                                                <FileText size={36} className='text-[#1D4ED8] bg-[#DBEAFE] p-2 rounded-[10px]' />
                                                <div>
                                                    <p className='text-sm text-[#111827] font-medium'>Company_Registration_Certificate.pdf</p>
                                                    <p className='text-[12px] text-[#6B7280]'>890 KB • Uploaded on 28 Mar 2026</p>
                                                </div>
                                            </div>
                                            <div className='text-[#6B7280] flex items-center justify-end gap-6' >
                                                <Eye size={20} />
