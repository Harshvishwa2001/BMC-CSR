        ...
        <div className='fixed inset-0 z-50 overflow-y-auto bg-black/80 backdrop-blur-sm transition-opacity p-10 flex items-center justify-center'>
            <div className="flex flex-col items-center justify-center py-12 text-center bg-white w-230 rounded-2xl">
                ...
                <div className="flex flex-wrap items-center justify-center gap-4 border border-slate-200 rounded-2xl p-4 px-30">
                    <button className="flex items-center gap-2 text-sm bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700 transition-colors">
                        <LayoutDashboard size={18} />
                        Go to Dashboard
                    </button>

                    <button className="flex items-center text-sm gap-2 border border-blue-500 text-blue-600 px-4 py-2 rounded-md hover:bg-blue-50 transition-colors">
                        <Eye size={18} />
                        View Project
                    </button>

                    <button className="flex items-center gap-2 text-blue-600 font-medium px-4 py-2 hover:underline">
                        <Plus size={20} />
